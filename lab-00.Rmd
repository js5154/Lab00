...
```{r setup-tibble}
team_data <- tibble(
  name = c("Peter Rabbit", "Joe", "", 
           "member 3", "member 4"),
  github_username = c("mcgregors-garden", "js5154", "username 2", 
                      "username 3", "username 4"), 
  colour = c("powderblue", "honeydew", "wheat1", 
             "seashell2", "slategray3"),
  hobby = c("Hopping", "bouldering", "kb", 
            "hobby 3", "hobby 4"),
